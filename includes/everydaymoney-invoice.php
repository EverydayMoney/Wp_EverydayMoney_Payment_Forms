...
<div class="content-area main-content" id="primary">
    <main role="main" class="site-main" id="main">
        <div class="blog_post">
            <article class="post-4 page type-page status-publish hentry" id="post-4">
                <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post"   enctype="multipart/form-data"  class="j-forms retry-form" id="emf-form" novalidate="">
                <input type="hidden" name="action" value="em_application_tech_retry_action">
    ...
    <div class="footer">
     <small><span style="color: red;">*</span> are compulsory</small><br>
      <img class="everydaymoney-pay-options size-full wp-image-1096" alt="cardlogos" src="<?php echo plugins_url('../images/everydaymoney-pay-options.png', __FILE__);?>">
